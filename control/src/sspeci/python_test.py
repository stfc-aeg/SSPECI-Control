...
if platform.system() == "Linux":
    anc350v4 = ctypes.cdll.LoadLibrary("./anc/libanc350v4.so")
elif platform.system() == "Windows":
    anc350v4 = ctypes.windll.LoadLibrary("./anc/anc350v4.dll")
...
# # libc = cdll.LoadLibrary("./anc/libanc350v4.so")
# # discover = getattr(libc, "ANC_discover")
# # connect = getattr(libc, "ANC_connect")

# try:
#     print(discover())
#     device = ctypes.c_void_p()
#     print(connect(0, ctypes.byref(device)))
